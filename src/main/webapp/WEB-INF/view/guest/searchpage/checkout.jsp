...
<%--                                </tr>--%>
<%--                                &lt;%&ndash;                                    <tr>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <td colspan="3"><strong>Total:</strong></td>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <td><strong>$<fmt:formatNumber value="${total}" type="number" maxFractionDigits="2" minFractionDigits="2"/></strong></td>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                    </tr>&ndash;%&gt;--%>
<%--                            </c:when>--%>
<%--                            <c:otherwise>--%>
<%--                                <tr>--%>
