    ...
    <div class="row">
        ...
        <div class="col-md-6" style="
            ...
            <div class="review_btn">
                ...
                <button class="btn btn-secondary mx-4">Learn More</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="col-md-12" id="Member">
        <h1 class="text-center">Better landing for your up</h1>
        <p class="text-center">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="d-flex flex-column justify-content-between border rounded-2 h-100"
