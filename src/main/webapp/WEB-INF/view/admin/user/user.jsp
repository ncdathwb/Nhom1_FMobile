...
<div class="container-xxl position-relative bg-white d-flex p-0">
    ...
    <div class="content">
        ...
        <form:form method="post" action="/admin/create/user" modelAttribute="newUser" id="userForm">
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="d-flex justify-content-between align-items-center mt-3">
            <p>Showing ${users.size()} of ${totalItems} Users</p>
            <nav aria-label="Page navigation">
                <ul class="pagination m-0">
                    <!-- Nút Previous -->
                    <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                        <a class="page-link" href="?pageNo=${currentPage - 1}&search=${search}" aria-label="Previous">
                    ...
                    <c:forEach var="i" begin="1" end="${totalPages}">
                        <li class="page-item ${currentPage == i ? 'active' : ''}">
                            <a class="page-link" href="?pageNo=${i}&search=${search}">${i}</a>
                        </li>
                    </c:forEach>

                    <!-- Nút Next -->
                    <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                        <a class="page-link" href="?pageNo=${currentPage + 1}&search=${search}" aria-label="Next">
